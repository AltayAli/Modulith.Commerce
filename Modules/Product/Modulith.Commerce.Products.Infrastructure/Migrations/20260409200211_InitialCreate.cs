        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddToFilter = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cost_Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    DiscountCount_Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DiscountCount_Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CategoryPropertyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryPropertyValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryPropertyValues_CategoryProperties_CategoryPropertyId",
                        column: x => x.CategoryPropertyId,
                        principalTable: "CategoryProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryPropertyValues_ProductVariants_ProductVariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantProperties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariantProperties_CategoryProperties_CategoryPropertyId",
                        column: x => x.CategoryPropertyId,
                        principalTable: "CategoryProperties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantProperties_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryPropertyValues_CategoryPropertyId",
                table: "CategoryPropertyValues",
                column: "CategoryPropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryPropertyValues_ProductVariantId",
                table: "CategoryPropertyValues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantProperties_CategoryPropertyId",
                table: "ProductVariantProperties",
                column: "CategoryPropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantProperties_ProductVariantId_CategoryPropertyId",
                table: "ProductVariantProperties",
                columns: new[] { "ProductVariantId", "CategoryPropertyId" },
                unique: true);
